...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class HiltLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>compailer</b> with <b>androidx.hilt:hilt-compiler</b> coordinates and
         * with version reference <b>hilt.compailer</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompailer() {
            return create("hilt.compailer");
        }
    ...
    public static class HiltAndroidLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>compailer</b> with <b>com.google.dagger:hilt-android-compiler</b> coordinates and
         * with version reference <b>hilt</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompailer() {
            return create("hilt.android.compailer");
        }
    ...
    public static class RoomLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>compailer</b> with <b>androidx.room:room-compiler</b> coordinates and
         * with version reference <b>room</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompailer() {
            return create("room.compailer");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>rv</b> with value <b>1.3.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRv() { return getVersion("rv"); }
    ...
    public static class HiltVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>hilt.compailer</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCompailer() { return getVersion("hilt.compailer"); }
    ...
    public static class ComGooglePluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>com.google.ksp</b> with plugin id <b>com.google.devtools.ksp</b> and
         * with version reference <b>ksp</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getKsp() { return createPlugin("com.google.ksp"); }
    ...
    public static class PluginPluginAccessors extends PluginFactory {
        private final PluginDaggerPluginAccessors paccForPluginDaggerPluginAccessors = new PluginDaggerPluginAccessors(providers, config);

        public PluginPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of plugins at <b>plugins.plugin.dagger</b>
         */
        public PluginDaggerPluginAccessors getDagger() {
            return paccForPluginDaggerPluginAccessors;
        }

    }

    public static class PluginDaggerPluginAccessors extends PluginFactory {

        public PluginDaggerPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>plugin.dagger.hilt</b> with plugin id <b>com.google.dagger.hilt.android</b> and
         * with version reference <b>hilt</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getHilt() { return createPlugin("plugin.dagger.hilt"); }
