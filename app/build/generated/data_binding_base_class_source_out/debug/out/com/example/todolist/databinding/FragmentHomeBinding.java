...
public final class FragmentHomeBinding implements ViewBinding {
  ...
  private FragmentHomeBinding(@NonNull CoordinatorLayout rootView,
      @NonNull ExtendedFloatingActionButton fab, @NonNull RecyclerView rvTodoList,
      @NonNull ToolbarBinding toolbarMain) {
  ...
  public static FragmentHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeBinding((CoordinatorLayout) rootView, fab, rvTodoList,
          binding_toolbarMain);
    }
