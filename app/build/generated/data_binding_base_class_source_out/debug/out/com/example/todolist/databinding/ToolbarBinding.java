...
public final class ToolbarBinding implements ViewBinding {
  ...
  private ToolbarBinding(@NonNull AppBarLayout rootView, @NonNull AppBarLayout appbar,
      @NonNull TextView sayHello, @NonNull TextView title, @NonNull MaterialToolbar toolbar) {
  ...
  public static ToolbarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.say_hello;
      TextView sayHello = ViewBindings.findChildViewById(rootView, id);
      if (sayHello == null) {
        break missingId;
      }
      ...
      return new ToolbarBinding((AppBarLayout) rootView, appbar, sayHello, title, toolbar);
    }
