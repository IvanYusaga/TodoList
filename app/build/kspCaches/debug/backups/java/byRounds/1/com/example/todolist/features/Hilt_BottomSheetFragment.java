...
public abstract class Hilt_BottomSheetFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BottomSheetFragment() {
    super();
  }

  Hilt_BottomSheetFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BottomSheetFragment_GeneratedInjector) this.generatedComponent()).injectBottomSheetFragment(UnsafeCasts.<BottomSheetFragment>unsafeCast(this));
    }
  }
